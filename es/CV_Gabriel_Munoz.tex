...
\begin{twenty} % Environment for a list with descriptions
	...
	\begin{itemize}
	\item Desde 2015, dirigiendo la renovación tecnológica, transformamos sistemas de información \emph{legacy} en nuevas soluciones técnicamente avanzadas. Dirijo y coordino la estrategia tecnológica de Berger Levrault en España. Participo como referente técnico en proyectos internacionales de la compañía. Coordino los proyectos de investigación que Berger Levrault realiza en colaboración con diferentes universidades españolas.
	...
	\item Con anterioridad asumí el puesto de responsable técnico de productos del área económico-financiera (Gestión Patrimonial, Gestión de Subvenciones), liderando los equipos de desarrollo y evolución técnica de los productos.
	\end{itemize} 
	}
